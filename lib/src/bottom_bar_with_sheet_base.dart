...
import 'package:bottom_bar_with_sheet/src/widgets/secondary_action_button.dart';
...
class BottomBarWithSheet extends StatefulWidget {
  BottomBarWithSheet({
    ...
    this.secondaryActionButtonTheme = defaultSecondaryButtonTheme,
    this.autoClose = true,
    this.onSelectItem,
    this.controller,
  ...
  /// theme of [SecondaryActionButtonTheme]
    ...
    return ItemsGenerator.generateByButtonPosition(
      mainActionButton: _isOpened
          ...
          : SecondaryActionButton(
              ...
              secondaryActionButtonTheme: widget.secondaryActionButtonTheme,
              arrowAnimation: _arrowAnimation,
              arrowAnimationController: _arrowAnimationController,
              enable: !widget.disableMainActionButton),
      items: widget.items
